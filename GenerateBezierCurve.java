...
public class GenerateBezierCurve {
    ...
    public static void main(String[] args) {
        Point2D p0 = new Point2D(0, 0); // start
        Point2D p1 = new Point2D(0.1, 0.2); // control point 1
        Point2D p2 = new Point2D(0.4, 0.3); // control point 2
        Point2D p3 = new Point2D(0.5, 0.7); // end
